...
class StudentIdForParent extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        if (localStorage.getItem('token') === null) {
            ...
            const path = STUDENTS + "/" + this.props.match.params.id + "/for-user";
                    ...
                    <div>
                        ...
                        <div className="student_page">
                            <div className="s_column_row">
                                ...
                                <button tabindex="4" className="s_column" onClick={this.showAboutTab}>About Student</button>
                                <button tabindex="4" className="s_column" onClick={this.showFormTab}>Form</button>
                                <button tabindex="4" className="s_column" onClick={this.showParentTab}>Parent</button>
                                <button tabindex="4" className="s_column" onClick={() => this.showMarksTab(this.state.student.ID)}>Marks</button>
...
export default StudentIdForParent;